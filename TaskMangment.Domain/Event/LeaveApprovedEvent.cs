...
namespace TaskMangment.Domain.Event
{
    public class LeaveApprovedEvent
    {
        ...
        public LeaveApprovedEvent(int leaveId,int employeeId,string employeeName,string approvedByName, string leaveTypeName,DateTime startDate,DateTime endDate)
        {
            LeaveId = leaveId;
