...
import { WarningDto } from "app/core/models/dashboard/dashboard.model";
...
@Component({
  ...
  template: `
    <div class="modal-header">
      <h5 class="modal-title">{{ 'TASK.WARNINGS' | translate }}</h5>
...
export class WarningsPopupComponent {
